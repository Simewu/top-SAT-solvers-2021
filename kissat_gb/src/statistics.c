...
// void 
// kissat_print_elementary_statistics(kissat *solver){
//   const double time = kissat_process_time ();
//   printf("%s %d %f %"PRId64" %"PRId64" %"PRId64" %"PRId64" %f %f %"PRId64" %d %d\n",
//   solver->fileName,
//   solver->state,
//   time,
//   solver->statistics.restarts,
//   solver->statistics.decisions,
//   solver->statistics.propagations,               
//   solver->statistics.conflicts,
//   (double)solver->statistics.conflicts / (double) solver->statistics.decisions,
//   (double) solver->statistics.total_glue / (double) solver->statistics.conflicts,
//   solver->statistics.num_glue,
//   solver->stable_g,
//   solver->gbumped); 
// }
